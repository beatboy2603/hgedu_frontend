...
export default class ModalFormula extends Component {
    render() {
        return (
            <div>
                
                <Modal id="addFormula" options={{ preventScrolling: true }} style={{ width: "40vw", maxHeight: "25vw", height: "25vw", marginTop:"10vh", overflow: "hidden", borderRadius: "25px"}} actions={[]}>
                    ...
                    <div className="modal-content" style={{
                        ...
                        <h5 className="center">Thêm công thức</h5>
