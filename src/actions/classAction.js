...
export const getClasses = id => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/${id}`);
    dispatch({
      type: GET_CLASSES,
      payload: res.data
    });
  ...
  export const getTeacher = userId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/teacher/${userId}`);
    dispatch({
      type: GET_TEACHER,
      payload: res.data
    })
  ...
  export const getClassesByStudentId = studentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/studentClass/${studentId}`);
    dispatch({
  ...
  export const getStudentsByParentId = parentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/parentStudent/${parentId}`);
    dispatch({
  ...
  export const getConnnectedStudent = teacherId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/studentTeacher/connected/${teacherId}`);
    dispatch({
  ...
  export const getConnnectedTeacher = studentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/studentTeacher/connected/teacher/${studentId}`);
    dispatch({
  ...
  export const getStudentTeacher = teacherId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/studentTeacher/${teacherId}`);
    dispatch({
  ...
  export const getStudentTeacher1 = studentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/studentTeacher/teacher/${studentId}`);
    dispatch({
  ...
  export const getParent = studentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/parent/${studentId}`);
    dispatch({
      type: GET_PARENT,
      payload: res.data
    })
  ...
  export const getClassStudents = classId => async dispatch => {
    const res = await axios.get(
      `http://localhost:8084/api/class/classStudent/${classId}`
    );
    dispatch({
  ...
  export const getExamByClassId = () => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/exam`);
    dispatch({
  ...
  export const parentGetTeacherByStudentId = studentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/parentFindTeacher/${studentId}`);
    dispatch({
  ...
  export const getClassStudentsByStudentId = studentId => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/classStudent/classes/${studentId}`);
    dispatch({
  ...
  export const getStudents = id => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/students/${id}`);
    dispatch({
      type: GET_STUDENTS,
      payload: res.data
    });
  ...
  export const getGrade = id => async dispatch => {
    const res = await axios.get(`http://localhost:8084/api/class/student/${id}`);
    dispatch({
      type: GET_GRADE,
      payload: res.data
    });
  ...
  export const createClass = class1 => async dispatch => {
    try {
      const res = await axios.post("http://localhost:8084/api/class/", class1);
      dispatch({
        type: GET_ERRORS,
        payload: {}
      });
  ...
  export const deleteClass = id => async dispatch => {
    if (window.confirm("Are you sure?")) {
      await axios.delete(`http://localhost:8084/api/class/${id}`);
      dispatch({
        type: DELETE_CLASS,
        payload: id
      });
  ...
  export const deleteStudent = id => async dispatch => {
    if (window.confirm("Are you sure?")) {
      await axios.delete(`http://localhost:8084/api/class/student/${id}`);
      dispatch({
        type: DELETE_STUDENT,
        payload: id
      });
  ...
  export const deleteStudentTeacher = studentId => async dispatch => {
    if (window.confirm("Are you sure?")) {
      await axios.delete(`http://localhost:8084/api/class/studentTeacher/${studentId}`);
      dispatch({
